...
public record BuyerQuickOrderRequestDto(
        ...
        String shippingShopIdUsed,
        Integer shippingFromDistrictId,
        String shippingFromWardCode,
        Integer shippingToDistrictId,
        String shippingToWardCode,
        Integer shippingWeight,
        Integer shippingLength,
        Integer shippingWidth,
        Integer shippingHeight,
        Integer shippingServiceTypeId,
        Integer shippingServiceId,
        BigDecimal shippingInsuranceValue,
        String shippingRawQuoteRequest,
        String shippingRawQuoteResponse,
        String orderStatus,
        String note) {
}
